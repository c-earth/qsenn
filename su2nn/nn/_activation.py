...
from su2nn.math import normalize2mom
...
class Activation(torch.nn.Module):
    ...
    and time reversal symmetry (odd or even).
    ...
    def __init__(self, irreps_in, acts):
        ...
        from su2nn.util._argtools import _get_device
        ...
        for (mul, (l_in, p_in, t_in)), act in zip(irreps_in, acts):
            if act is not None:
                ...
                irreps_out.append((mul, (0, p_out, t_in)))
