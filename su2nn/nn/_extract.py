...
class Extract(CodeGenMixin, torch.nn.Module):
    ...
    def __init__(self, irreps_in, irreps_outs, instructions, squeeze_out: bool = False):
        ...
        irreps_outs : list of `su2nn.su2.Irreps`
        ...
        self.irreps_outs = tuple(su2.Irreps(irreps) for irreps in irreps_outs)
...
class ExtractIr(Extract):
    ...
    def __init__(self, irreps_in, ir):
        ...
        self.irreps_out = su2.Irreps([mul_ir for mul_ir in irreps_in if mul_ir.ir == ir])
