...
class FullyConnectedTensorProduct(TensorProduct):
    ...
    Parameters
    ----------
    irreps_in1 : `su2nn.su2.Irreps`
        representation of the first input

    irreps_in2 : `su2nn.su2.Irreps`
    ...
    def __init__(
        ...
        irreps_in1 = su2.Irreps(irreps_in1)
        irreps_in2 = su2.Irreps(irreps_in2)
        irreps_out = su2.Irreps(irreps_out)
...
class ElementwiseTensorProduct(TensorProduct):
    ...
    filter_ir_out : iterator of `su2nn.su2.Irrep`, optional
        filter to select only specific `su2nn.su2.Irrep` of the output
    ...
    def __init__(self, irreps_in1, irreps_in2, filter_ir_out = None, irrep_normalization: str = None, **kwargs):
        ...
        irreps_in1 = su2.Irreps(irreps_in1).simplify()
        irreps_in2 = su2.Irreps(irreps_in2).simplify()
...
class FullTensorProduct(TensorProduct):
    ...
    def __init__(
                 self,
                 irreps_in1: su2.Irreps,
                 irreps_in2: su2.Irreps,
                 filter_ir_out: Iterator[su2.Irrep] = None,
                 irrep_normalization: str = None,
                 **kwargs,
                ):
...
class TensorSquare(TensorProduct):
    ...
    irreps_out : `su2nn.su2.Irreps`, optional
        representation of the output
    ...
    def __init__(
                 self,
                 irreps_in: su2.Irreps,
                 irreps_out: su2.Irreps = None,
                 filter_ir_out: Iterator[su2.Irrep] = None,
                 irrep_normalization: str = None,
                 **kwargs,
                ):
        ...
        if irreps_out is None:
            ...
            irreps_out = su2.Irreps(irreps_out).simplify()
