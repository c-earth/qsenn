...
Note that the representation of direct product defined in equation \ref{eq:direct product representation} does not guarantee irreducible representation from product of two irreducible representation, nor complete identification of all irreducible representations of the groups' direct product.

\subsection{Direct Product of Commuting Groups}
